    ...
    public NodeComponent getProxy() throws Exception {
        ...
        try {
            ...
            Object instance = new ByteBuddy().subclass(declWarpBean.getNodeType().getMappingClazz())
                    ...
                    .defineField("target", Object.class, Visibility.PRIVATE)
                    .defineMethod("setTarget", void.class, Visibility.PUBLIC)
            ...
            // 给代理对象设置 target 字段
            instance.getClass().getMethod("setTarget", Object.class).invoke(instance, declWarpBean.getRawBean());
